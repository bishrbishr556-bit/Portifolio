    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div className="space-y-8">
        ...
        <div className="flex gap-4 pt-8">
          {[
            { Icon: Github, href: 'https://github.com/bishrbishr556-bit' },
            { Icon: Linkedin, href: 'https://www.linkedin.com/in/bishr-mhd-62a422411/' },
            { Icon: Instagram, href: 'https://www.instagram.com/' },
          ].map(({ Icon, href }, idx) => (
            <a key={idx} href={href} target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-purple-400 hover:border-purple-400/50 transition-all">
              <Icon size={20} />
            </a>
          ))}
          {/* Pinterest */}
          <a href="https://in.pinterest.com/PixeloraX/" target="_blank" rel="noopener noreferrer"
            className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-red-400 hover:border-red-400/50 transition-all">
    ...
    <div className="grid md:grid-cols-[1.5fr_1fr] gap-12">
      ...
      <div className="space-y-6">
        <div className="glass-card p-6 flex flex-col gap-6">
          ...
          {[
            { icon: <Mail />, label: 'Email', val: 'hello@bishr.me' },
